...
TAB AS (
 SELECT CLICODIGO,MAX(TBPPCDESCTO2)MXDESCTO  FROM TBPPRODU T
...
SELECT C.CLICODIGO,
        T.TBPCODIGO,
         T.PROCODIGO MONTAGEM,
          TBPPCDESCTO DESCTO_MONT,
           TBPPCDESCTO2 DESCTO_MONT2,
          ROUND(PREPCOVENDA2*(1-TBPPCDESCTO2*1.00/100),2) VALOR_MONTAGEM
           FROM TBPPRODU T
